...
public class GenerateRSAKeys{
    public static void main(String[] args) {
        try {
            ...
            // 4. Encodage des clés en Base64 pour les enregistrer sous format textelisible (PEM)
            ...
            writeToFile("src/main/resources/publicKey.pem", publicKeyPEM);
            writeToFile("src/main/resources/privateKey.pem", privateKeyPEM);
